...
!-------------------------------------------------------------------------------
 ...
 Program main
   ...
   integer                 :: i, j, k, n, m, &
                              ...
                              Ostar2,  &  !Index of the Ostar2 (Shared Proton)     
                              Hprime,  &  !Index of the Hprime
                              Hshared, &  !Index of the shared Proton
                              O_count, &  !Counting Index of Ostars
                              Ostar_x, &  !Current Ostar in the shared
   ...
   if (myid == 0 ) then
      ...
      !Input: COMMAND LINE ARUGMENTS! 1) outfile 2) Ostar1 3)Ostar2
      ...
      !open(unit=21, file=infile, IOSTAT=ierr, STATUS='unknown')
      !if (ierr /= 0) then
   ...
   if(myid == 0) then
      ...
      open(unit=2, file=eigfile, IOSTAT=ierr, STATUS='unknown')
      if(ierr /= 0) then
